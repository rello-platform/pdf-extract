 ...
 */
export type { PdfTextItem, PdfRect, ClusterRowsOptions, DetectColumnAnchorsOptions, GetItemsInRectOptions, } from "./types";
export { clusterItemsIntoRows, detectColumnAnchors, getItemsInRect, nearestColumnAnchor, rowText, } from "./geometry";
